...
public class Account {
	...
	public Account(int id, String accountStatus, double accountNumber, double accountTotalBalance, String accountType,
			int clientId) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Account [id=" + id + ", accountStatus=" + accountStatus + ", accountNumber=" + accountNumber
				+ ", accountTotalBalance=" + accountTotalBalance + ", accountType=" + accountType + ", clientId="
				+ clientId + "]";
	}
